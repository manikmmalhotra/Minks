...
function App() {
  ...
  return (
    <>
      ...
      <div className="frame">
        <h1 className="frame__title">MINKS</h1>
        <div className="frame__links">
          <a className="frame__link" href="https://github.com/manikmmalhotra/">
            Github
          </a>
          <a
            className="frame__link"
            href="https://www.linkedin.com/in/manik-malhotra-029a22193/"
          >
            LinkedIn
          </a>
          <a className="frame__link resume" href="https://github.com/Luzaks/">
            Resume
          </a>
        </div>
